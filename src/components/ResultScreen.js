...
export const ResultScreen = () => {
    const { titulo_original, subtitle, titulo_predicho, image, lyrics, historial,letraNube, palabras, res, sentimientos, pesos_topico  } = useSelector(state => state.data)
    // const {    } = historial;
    ...
    return (
        <div>
            ...
            <div className="contenedor-centrar">
                <a className="btn-primario a-btn" href="/" role="button">TRY ANOTHER SONG </a>
            </div>
        </div >
    )
}
